...
const ContentCard: React.FC<ContentCardProps> = ({ 
  ...
  const handlePlayClick = () => {
    ...
    console.log('ContentCard navigating to player with full data:', fullContentData);
    navigate('/player', { state: fullContentData });
  };
  ...
  const handleInfoClick = () => {
    ...
    console.log('ContentCard passing full database object to MoreInfo:', fullContentData);
    navigate('/more-info', { state: fullContentData });
  };
